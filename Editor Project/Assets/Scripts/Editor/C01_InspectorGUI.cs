...
[CustomEditor(typeof(C01_ComponentExample))]
public class C01_InspectorGUI : Editor {
    private C01_ComponentExample targetRef;
    ...
    private void OnEnable() {
        ...
        targetRef = (C01_ComponentExample)target;
        ...
        myString = serializedObject.FindProperty(nameof(C01_ComponentExample.myString));
