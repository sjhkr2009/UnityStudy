...
[CustomEditor(typeof(C01_Example))]
public class C01_InspectorGUI : Editor {
    private C01_Example targetRef;
    ...
    private void OnEnable() {
        ...
        myString = serializedObject.FindProperty(nameof(C01_Example.myString));
