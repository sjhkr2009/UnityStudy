...
[Preserve]
public class TMPShaderEditor : TMP_BaseShaderGUI {
    ...
    void DoUnderlayPanel2() {
        EditorGUI.indentLevel += 1;
        s_UnderlayFeature.DoPopup(m_Editor, m_Material);
        DoColor("_UnderlayColor2", "Color");
        DoSlider("_UnderlayOffsetX2", "Offset X");
        DoSlider("_UnderlayOffsetY2", "Offset Y");
        DoSlider("_UnderlayDilate2", "Dilate");
        DoSlider("_UnderlaySoftness2", "Softness");
        EditorGUI.indentLevel -= 1;
        EditorGUILayout.Space();
    }
