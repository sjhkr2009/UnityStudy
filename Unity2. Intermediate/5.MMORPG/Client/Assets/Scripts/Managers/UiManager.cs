...
public class UiManager
{
    ...
    public T ShowSceneUI<T>(string name = null) where T : BaseUIScene
    {
        ...
        GameObject go = Director.Resource.Instantiate(Define.ResourcesPath.ToSceneUI(name), Root);
    ...
    public T ShowPopupUI<T>(string name = null) where T : BaseUIPopup
	{
        ...
        GameObject go = Director.Resource.Instantiate(Define.ResourcesPath.ToPopupUI(name), Root);
    ...
    public T MakeSubItem<T>(Transform parent, string name = null) where T : BaseUI
	{
        ...
        GameObject go = Director.Resource.Instantiate(Define.ResourcesPath.ToSubItemUI(name), parent);
    ...
    public T MakeWorldSpace<T>(Transform parent, string name = null) where T : BaseUI
    {
        ...
        GameObject go = Director.Resource.Instantiate(Define.ResourcesPath.ToWorldSpaceUI(name), parent);
    ...
    public bool ClosePopupUI()
	{
        ...
        Director.Resource.Destroy(target.gameObject);
        target = null;
